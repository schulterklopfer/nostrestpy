...
resp = nostrest.get('nostrest://8e70c70ceff84b8ff2b95bc35f12f766c24bca06256beb07846b736a0fa6cb99/keys')
if resp:
    resp.raise_for_status()
    body = resp.json()
    print(body)

resp = nostrest.get('nostrest://8e70c70ceff84b8ff2b95bc35f12f766c24bca06256beb07846b736a0fa6cb99/keysets')
if resp:
    resp.raise_for_status()
    body = resp.json()
    print(body)
